    ...
    <div class="col-12 mb-3">
        <div class="row">
            <div class="col-12 col-md-6">
                <p class="">
                    Start today, capitalize your website user base or social media traffic. We are looking for new online
            ...
            <div class="col-12 col-md-6 col-lg-4 px-2 py-2">
                <div class="card freedy-card piggy text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Open your account and receive your affiliate link for free</p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4 px-2 py-2">
